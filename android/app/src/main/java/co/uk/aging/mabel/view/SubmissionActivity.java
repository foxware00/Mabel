...
public class SubmissionActivity extends Activity {
    ...
    private boolean mHasShownTextEditOnce = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextView = (EditText) findViewById(R.id.post_text_view);
        mPostButton = (Button) findViewById(R.id.post_button);
        mCameraButton = (Button) findViewById(R.id.post_upload_media_button);
        mDeletePhoto = (Button) findViewById(R.id.post_delete_media_button);
        ...
        if(mTextView.requestFocus() && !mHasShownTextEditOnce) {
            mHasShownTextEditOnce = true;
