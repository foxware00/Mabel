package co.uk.aging.mabel.places;
...
import co.uk.aging.mabel.places.search.AlertDialogManager;
import co.uk.aging.mabel.places.search.ConnectionDetector;
import co.uk.aging.mabel.places.search.GPSTracker;
import co.uk.aging.mabel.places.search.GooglePlaces;
import co.uk.aging.mabel.places.search.Place;
import co.uk.aging.mabel.places.search.PlacesList;
...
public class SearchActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (gps.canGetLocation()) {
            ...
            alert.showAlertDialog(SearchActivity.this, "GPS Status",
